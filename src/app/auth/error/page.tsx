...
export default function AuthError() {
    return (
        <main className="h-calc-full-height flex items-center justify-center">
            <article className="shadow-floating-sm from-secondary to-tertiary text-text-primary grid w-full max-w-sm place-items-center space-y-5 rounded-2xl bg-linear-150 from-15% to-85% p-6">
