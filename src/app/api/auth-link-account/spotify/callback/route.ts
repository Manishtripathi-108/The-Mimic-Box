    ...
    try {
        ...
        await db.linkedAccount.upsert({
            ...
            update: {
                ...
                image: userProfile.images.find((image) => image.width && image.width < 300)?.url || null,
                bannerImage: userProfile.images.find((image) => image.width && image.width >= 300)?.url || null,
