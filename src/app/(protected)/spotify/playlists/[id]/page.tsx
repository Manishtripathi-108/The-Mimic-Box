...
import MusicSpotifyPlaylist from '@/app/(protected)/spotify/playlists/[id]/_component/MusicSpotifyPlayList';
...
export const generateMetadata = async ({ params }: { params: Promise<{ id: string }> }): Promise<Metadata> => {
    ...
    if (!res.success || !res.payload) {
        return {
            ...
            keywords: ['Spotify', 'Playlist', 'Music', 'Mimic', 'Metadata', 'Not Found'],
        };
    }
    ...
    return {
        ...
        keywords: ['Spotify', 'Playlist', 'Music', 'Mimic', 'Metadata', playlist.name, ownerName],
        openGraph: {
            images: [
                {
