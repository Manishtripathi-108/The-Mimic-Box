...
const HorizontalScrollSection = ({ children, onMoreClick, title }: { children: React.ReactNode; onMoreClick: () => void; title: string }) => {
    return (
        <section>
            ...
            <div className="relative">
                ...
                <div className="scrollbar-hide flex gap-2 overflow-x-auto px-4 sm:gap-4 sm:px-6 sm:[scrollbar-width:none]">{children}</div>
            </div>
        </section>
    );
};
