...
function VerifyEmailContent({ router }: { router: ReturnType<typeof useRouter> }) {
    ...
    return (
        <>
            <title>Verify Your Email | The Mimic Box</title>
            <meta name="description" content="Verify your email address to activate your account on The Mimic Box." />
            <meta name="robots" content="index, follow" />
            <meta property="og:title" content="Verify Your Email | The Mimic Box" />
            <meta property="og:description" content="Verify your email address to activate your account on The Mimic Box." />
            <meta property="og:type" content="website" />
            <meta property="og:url" content={`${process.env.NEXT_PUBLIC_URL}${APP_ROUTES.AUTH.VERIFY_EMAIL}`} />
                    ...
                    {token && (!state || state?.success) ? (
                        <div className="p-6">
                            ...
                            <form action={verifyAction}>
                                <button type="submit" className="button bg-highlight mt-4 w-full text-white" disabled={isPending}>
                        ...
                        <div className="p-6">
                            ...
                            <Link href={APP_ROUTES.AUTH.LOGIN} replace className="button bg-highlight mt-4 w-full text-white">
                                Request New Token
                            </Link>
