    ...
    if (!session.data) {
        return (
            <Link
                ...
                className="bg-primary hover:text-text-primary text-text-secondary shadow-neumorphic-xs flex cursor-pointer items-center gap-x-1 rounded-full px-4 py-2">
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        exit={{ opacity: 0, y: -10 }}
                        className="bg-primary shadow-neumorphic-xs absolute right-2 z-50 mt-5 w-72 rounded-3xl border p-2">
                        <div className="shadow-neumorphic-inset-xs mb-2 flex aspect-[4/3] w-full flex-col items-center justify-center rounded-2xl border">
                            <div className="shadow-neumorphic-xs mb-2 flex items-center justify-center rounded-3xl border p-2">
                                <Image
                                    src={session.data?.user?.image || 'https://picsum.photos/200'}
                                    alt="Profile"
                                    width={72}
                        ...
                        <div className="text-text-secondary">
                            <button className="hover:bg-secondary hover:text-text-primary flex w-full cursor-pointer items-center gap-x-3 rounded-lg px-3 py-2">
                            ...
                            <button
                                ...
                                className="hover:bg-secondary hover:text-text-primary flex w-full cursor-pointer items-center gap-x-3 rounded-lg px-3 py-2">
                        ...
                        <button
                            onClick={() => signOut()}
                            className="hover:bg-secondary flex w-full cursor-pointer items-center gap-x-3 rounded-lg px-3 py-2 text-red-500">
