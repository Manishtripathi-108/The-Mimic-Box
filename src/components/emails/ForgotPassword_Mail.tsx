...
const ForgotPassword_Mail = ({ token }: { token: string }) => {
    const publicUrl = process.env.NEXT_PUBLIC_URL || 'https://the-mimic-box.com';
    const forgotPassUrl = new URL(`${APP_ROUTES.AUTH.RESET_PASSWORD}?token=${token}`, publicUrl).toString();
                ...
                <Body className="bg-gray-100 font-sans">
                    <Container className="mx-auto max-w-lg rounded-lg bg-white p-6 shadow-md">
                        ...
                        <div className="pt-6 text-center">
                            ...
                            <Heading className="mt-4 text-2xl font-bold text-gray-800">Reset Your Password</Heading>
                        </div>

                        {/* Body Content */}
                        <Text className="mt-2 text-center text-gray-600">
                            We received a request to reset your password. If you didn’t make the request, you can safely ignore this email. This link
