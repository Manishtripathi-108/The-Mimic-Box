    ...
    return (
        <input
            ...
            className={cn(
                ...
                'file:bg-accent file:text-on-accent file:hover:bg-accent/90 file:inline-flex file:h-7 file:cursor-pointer file:border-0 file:text-sm file:font-medium file:transition-colors',
                DATA_INVALID,
                DISABLED,
                className
            )}
