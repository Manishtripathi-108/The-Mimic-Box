...
//         iphone: [
//             'iPhone; CPU iPhone OS 18_3_2 like Mac OS X',
//             'iPhone; CPU iPhone OS 18_3_1 like Mac OS X',
...
//     const chromeVersions = [134, 133, 132, 131, 130, 129, 128, 120, 119, 116, 110, 109, 108, 107, 104, 101, 100, 99, 91, 89, 58];
//     const safariVersion = '537.36';
//     const iosSafariVersions = ['18.3.2', '18.3.1', '18.1.1', '18.0', '17.6'];
//     const firefoxVersions = ['136.0'];
//     const obsidianVersions = ['1.8.4', '1.8.3', '1.8.9', '1.7.7'];
//     const edgeVersions = ['134.0.0.0', '133.0.0.0'];
//     const electronVersion = '33.3.2';

//     const results: string[] = [];

//     // Chrome Desktop
//     chromeVersions.forEach((v) => {
//         results.push(`Mozilla/5.0 (${platforms.windows}) AppleWebKit/${safariVersion} (KHTML, like Gecko) Chrome/${v}.0.0.0 Safari/${safariVersion}`);
//         results.push(`Mozilla/5.0 (${platforms.mac}) AppleWebKit/${safariVersion} (KHTML, like Gecko) Chrome/${v}.0.0.0 Safari/${safariVersion}`);
//         results.push(`Mozilla/5.0 (${platforms.linux}) AppleWebKit/${safariVersion} (KHTML, like Gecko) Chrome/${v}.0.0.0 Safari/${safariVersion}`);
//     });

//     // Chrome Mobile (Android)
//     chromeVersions.forEach((v) => {
//         results.push(
//             `Mozilla/5.0 (${platforms.android}) AppleWebKit/${safariVersion} (KHTML, like Gecko) Chrome/${v}.0.0.0 Mobile Safari/${safariVersion}`
//         );
//     });

//     // Chrome iOS (CriOS)
//     iosSafariVersions.forEach(() => {
//         results.push(`Mozilla/5.0 (${platforms.iphone[0]}) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/134.0.6998.99 Mobile/15E148 Safari/604.1`);
//     });

//     // iOS Safari
//     platforms.iphone.forEach((iphone, i) => {
//         results.push(
//             `Mozilla/5.0 (${iphone}) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/${iosSafariVersions[i] || '18.0'} Mobile/15E148 Safari/604.1`
//         );
//     });

//     // Firefox
//     firefoxVersions.forEach((version) => {
//         results.push(`Mozilla/5.0 (${platforms.windows}; rv:${version}) Gecko/20100101 Firefox/${version}`);
//         results.push(`Mozilla/5.0 (${platforms.mac}; rv:${version}) Gecko/20100101 Firefox/${version}`);
//         results.push(`Mozilla/5.0 (${platforms.linux}; rv:${version}) Gecko/20100101 Firefox/${version}`);
//     });

//     // Obsidian (Electron-based)
//     obsidianVersions.forEach((obsVer) => {
//         results.push(
//             `Mozilla/5.0 (${platforms.windows}) AppleWebKit/${safariVersion} (KHTML, like Gecko) obsidian/${obsVer} Chrome/130.0.6723.191 Electron/${electronVersion} Safari/${safariVersion}`
//         );
//     });
...
//         results.push(
//             `Mozilla/5.0 (${platforms.windows}) AppleWebKit/${safariVersion} (KHTML, like Gecko) Chrome/${version} Safari/${safariVersion} Edg/${version}`
//         );
//     });
